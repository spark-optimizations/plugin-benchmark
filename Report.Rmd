...
g1 <- show_run_plots("real", metricName="Time", unit="ms", scale=1, round=1, fNum=3, cap="Figure 3: Execution Time")
g2 <- show_run_plots("shuffle", metricName="Shuffle", unit="kb", scale=1024, round=0, fNum=4, cap="Figure 4: Shuffled Data")
